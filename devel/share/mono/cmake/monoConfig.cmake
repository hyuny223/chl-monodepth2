...
if("TRUE" STREQUAL "TRUE")
  set(mono_SOURCE_PREFIX /root/ws/src/mono)
  set(mono_DEVEL_PREFIX /root/ws/devel)
  set(mono_INSTALL_PREFIX "")
  set(mono_PREFIX ${mono_DEVEL_PREFIX})
else()
  set(mono_SOURCE_PREFIX "")
  set(mono_DEVEL_PREFIX "")
  set(mono_INSTALL_PREFIX /root/ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mono' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/ws/src/mono/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT mono_NUM_DUMMY_TARGETS)
      set(mono_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::mono::wrapped-linker-option${mono_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR mono_NUM_DUMMY_TARGETS "${mono_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::mono::wrapped-linker-option${mono_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND mono_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/ws/devel/lib;/root/ws/devel/lib;/opt/ros/melodic/lib)
